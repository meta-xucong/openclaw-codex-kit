...
| 文件 | 位置 |
|------|------|
| 商业评估 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/venture-analysis/business_evaluations.json` |
| 财务模型 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/venture-analysis/financial_models.json` |
| 估值分析 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/venture-analysis/valuations.json` |
| 尽调清单 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/venture-analysis/due_diligence/` |

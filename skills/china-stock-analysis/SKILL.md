...
| 文件 | 位置 |
|------|------|
| 股票数据 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/china-stock-analysis/stock_data/` |
| 分析结果 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/china-stock-analysis/analysis/` |
| 筛选结果 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/china-stock-analysis/screening/` |
| 估值结果 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/china-stock-analysis/valuation/` |

...
DB_DIR = Path.home() / ".claude" / "weather_forecast"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("\nUsage:")
        print("  python3 weather_db.py has_city")
        print("  python3 weather_db.py get_city")
        print("  python3 weather_db.py set_city <city_name>")
        print("  python3 weather_db.py get_config")
        sys.exit(1)

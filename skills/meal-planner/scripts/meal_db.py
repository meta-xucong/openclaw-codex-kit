...
DB_DIR = Path.home() / ".claude" / "meal_planner"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("\nUsage:")
        print("  python3 meal_db.py is_initialized")
        print("  python3 meal_db.py get_profile")
        print("  python3 meal_db.py targets")
        print("  python3 meal_db.py today")
        print("  python3 meal_db.py stats [days]")
        print("  python3 meal_db.py shopping_list [plan_id] --days 7")
        print("  python3 meal_db.py export")
        print("  python3 meal_db.py reset")
        sys.exit(1)

...
DB_DIR = Path.home() / ".claude" / "daily_reflection"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("\nUsage:")
        print("  python3 reflection_db.py is_initialized")
        print("  python3 reflection_db.py today")
        print("  python3 reflection_db.py weekly [YYYY-MM-DD]")
        print("  python3 reflection_db.py monthly [YYYY-MM]")
        print("  python3 reflection_db.py habits")
        print("  python3 reflection_db.py goals")
        print("  python3 reflection_db.py reading_stats [days]")
        print("  python3 reflection_db.py wellness_stats [days]")
        print("  python3 reflection_db.py stats [days]")
        print("  python3 reflection_db.py export")
        print("  python3 reflection_db.py reset")
        sys.exit(1)

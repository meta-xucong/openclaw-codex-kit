...
| 文件 | 位置 |
|------|------|
| 配置方案 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/wealth-allocation/allocations.json` |
| 组合数据 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/wealth-allocation/portfolios.json` |
| 追踪记录 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/wealth-allocation/tracking.json` |
| 再平衡记录 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/wealth-allocation/rebalance.json` |

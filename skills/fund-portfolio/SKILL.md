...
| 文件 | 位置 |
|------|------|
| 基金组合 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/fund-portfolio/portfolios.json` |
| 定投计划 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/fund-portfolio/sip_plans.json` |
| 风险评估 | `${CLAWDBOT_STATE_DIR:-~/.clawdbot}/skills/fund-portfolio/risk_reports.json` |

...
DB_DIR = Path(os.environ.get("CODEX_DATA_DIR", Path.cwd() / "codex-data")) / "travel_planner"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("\nUsage:")
        print("  python travel_db.py is_initialized")
        print("  python travel_db.py get_preferences")
        print("  python travel_db.py get_trips [current|past|ideas|all]")
        print("  python travel_db.py stats")
        print("  python travel_db.py export")
        print("  python travel_db.py reset")
        sys.exit(1)

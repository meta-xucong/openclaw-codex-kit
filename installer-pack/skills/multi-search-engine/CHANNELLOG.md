...
```javascript
// Google搜索
web reader({"url": "https://www.google.com/search?q=python"})

// 隐私搜索
web reader({"url": "https://duckduckgo.com/html/?q=privacy"})

// 站内搜索
web reader({"url": "https://www.google.com/search?q=site:github.com+python"})
```
